...
class GHOUST_TEST:
    ...
    def set_accel_thresh(self, out, warn):
        ...
        self.client.publish("GHOUST/clients/"+self.pid+"/config/accel_out", str(out))
        self.client.publish("GHOUST/clients/"+self.pid+"/config/accel_warn", str(warn))
	...
	print m
        self.client.publish("GHOUST/clients/"+self.pid+"/config/motor", "PRESET:1")
